...
public class ButtonExample : MonoBehaviour
{
   ...
   private void Default()
    ...
    [Button]
    private void Default(float a, float b, float[] c) { }
    ...
    [Button(ButtonSizes.Small), GUIColor(0.5f, 0.8f, 0.5f)]
    ...
    private void CompactBox(int a, int b, out float c)
    {
        c = a + b;
    }

    [Button(ButtonStyle.CompactBox, Expanded = true)]
    private void CompactExpanded(float a, float b, GameObject gameObject)
    {

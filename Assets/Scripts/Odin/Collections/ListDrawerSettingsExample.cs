...
public class ListDrawerSettingsExample : MonoBehaviour
{
    ...
    public int[] ReadOnlyArr1 = new int[] { 1, 2, 3 };

    [ReadOnly]
    public int[] ReadOnlyArr2 = new int[] { 1, 2, 3 };
    ...
    public SomeSruct[] InjectListElementGUI;

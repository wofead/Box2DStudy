...
public class ProgressBarExample : MonoBehaviour
{
    ...
    [ProgressBar(0,10,ColorGetter = "GetStackedHealthColor", BackgroundColorGetter = "GetStackHealthBackgroundColor", DrawValueLabel = false)]
    ...
    {
        return this.StackedHealth > 200 ? Color.white : this.StackedHealth > 100 ? Color.green : Color.red;
    }
